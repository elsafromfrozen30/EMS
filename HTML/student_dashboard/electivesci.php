...
<body>
  ...
  <h1>ELECTIVES BEING OFFERED UNDER SCIENCE STREAM</h1>
  <h1 id='something'></h1>
...
$sql = "SELECT DISTINCT stream  FROM admin_course WHERE cat = 'SCI'";

$result = $conns->query($sql);

$dictionary = array(
  "Chemistry" => "Chemistry is the scientific study of the properties and behavior of matter. It is a physical science under natural sciences that covers the elements that make up matter to the compounds made of atoms",
  "Physics" => "Physics is the natural science of matter, involving the study of matter, its fundamental constituents, its motion and behavior through space and time, and the related entities of energy and force.",
  "Mathematics" => "Mathematics is an area of knowledge that includes the topics of numbers, formulas and related structures, shapes and the spaces in which they are contained, and quantities and their changes"
